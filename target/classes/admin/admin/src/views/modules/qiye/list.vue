		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","background":"#fff","display":"block"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">企业账号</label>
			...
			<div :style='{"width":"100%","padding":"0 10px","fontSize":"14px","color":"#000"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column  :resizable='true' prop="qiyezizhi" width="200" label="企业资质">
						<template slot-scope="scope">
							<div v-if="scope.row.qiyezizhi">
								<img v-if="scope.row.qiyezizhi.substring(0,4)=='http'&&scope.row.qiyezizhi.split(',w').length>1" :src="scope.row.qiyezizhi" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.qiyezizhi)">
								<img v-else-if="scope.row.qiyezizhi.substring(0,4)=='http'" :src="scope.row.qiyezizhi.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.qiyezizhi.split(',')[0])">
								<img v-else :src="$base.url+scope.row.qiyezizhi.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView($base.url+scope.row.qiyezizhi.split(',')[0])">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
