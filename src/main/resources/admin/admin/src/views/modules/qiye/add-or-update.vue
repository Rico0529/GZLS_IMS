	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="upload" v-else-if="ruleForm.qiyezizhi" label="企业资质" prop="qiyezizhi" >
					<img v-if="ruleForm.qiyezizhi.substring(0,4)=='http'&&ruleForm.qiyezizhi.split(',w').length>1" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.qiyezizhi" width="100" height="100">
					<img v-else-if="ruleForm.qiyezizhi.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.qiyezizhi.split(',')[0]" width="100" height="100">
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.qiyezizhi.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
			</template>
